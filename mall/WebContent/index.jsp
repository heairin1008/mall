...
<div class="container">
	...
	<div><!-- 전체 카테고리 3 / 이미지 배너 9 -->
		<div class="row">
			<div class="col-sm-3">
					...
					%>
							<a class="nav-link" href="<%=request.getContextPath()%>/product/productList.jsp"><button class="btn btn-secondary btn-block" value=<%=c.getCategoryId()%>><%=c.getCategoryName()%></button></a>
					<%
						}
					%>
			</div>
	...
	<div class="text-align : center" style="margin:5px;">
		...
		%>
				<a class="col-sm-9" href=""><img src="<%=request.getContextPath()%>/images/<%=c.getCategoryPic()%>" class="rounded-circle" width="200" height="200"></a>
				&nbsp;
				&nbsp;
				&nbsp;
				&nbsp;
	...
	<table width="100%">
		...
		%>
				...
				<td>
					<a href="<%=request.getContextPath()%>" class="btn btn-secondary nav-link"><%=c.getCategoryName()%></a>
				</td>
				<td>&nbsp;</td>
		<%
			}
			...
			%>
					<td>
						<div class="card" style="width:300px">
	  						...
	  						<div class="card-body">
								<h5 class="card-title font-weight-bold" style="float:right;">
